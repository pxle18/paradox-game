...
namespace VMP_CNR.Module.NSA.Observation
{
    public class NSAObservationModule : SqlModule<NSAObservationModule, NSADBObservation, uint>
    {
        ...
        public void AgreeObservation(DbPlayer dbPlayer, NSAObservation nSAObservation)
        {
            ...
            dbPlayer.SendNewNotification($"Sie haben die Observation von {PlayerNameModule.Instance.Get((uint)nSAObservation.PlayerId).Name} genehmigt!");
        }
