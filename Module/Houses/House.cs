...
namespace VMP_CNR
{
    public class House : Loadable<uint>
    {
        ...
        public House(MySqlDataReader reader) : base(reader)
        {
            ...
            Container = Id == 0 ? null : ContainerManager.LoadContainer(Id, ContainerTypes.HOUSE, 0);
            LaborContainer = Id == 0 ? null : ContainerManager.LoadContainer(Id, ContainerTypes.LABOR_MEERTRAEUBEL, 0, 0);
            ...
            BlackMoneyInvContainer = Id == 0 ? null : ContainerManager.LoadContainer(Id, ContainerTypes.BLACKMONEYINVENTORY, 0);
            BlackMoneyCodeContainer = Id == 0 ? null : ContainerManager.LoadContainer(Id, ContainerTypes.BLACKMONEYCODES, 0);
            BlackMoneyBatterieContainer = Id == 0 ? null : ContainerManager.LoadContainer(Id, ContainerTypes.BLACKMONEYBATTERIE, 0);
    ...
    public static class HouseFunctions
    {
        ...
        public static void BuildKeller(this House iHouse, DbPlayer dbPlayer)
        {
            // 25 Zement, 60 Holzplanken
            iHouse.Container.RemoveItem(312, 25);
            iHouse.Container.RemoveItem(310, 60);

            dbPlayer.AddTask(PlayerTaskTypeId.KellerAusbau);
        }
        ...
        public static void BuildMoneyKeller(this House iHouse, DbPlayer dbPlayer)
        {
            // 10 Zement, 30 Holzplanken
            iHouse.Container.RemoveItem(312, 10);
            iHouse.Container.RemoveItem(310, 30);

            dbPlayer.AddTask(PlayerTaskTypeId.MoneyKellerAusbau);
        }
        ...
        public static void UpgradeKeller(this House iHouse, DbPlayer dbPlayer)
        {
            // 40 Zement, 100 Holzplanken
            iHouse.Container.RemoveItem(312, 40);
            iHouse.Container.RemoveItem(310, 100);

            dbPlayer.AddTask(PlayerTaskTypeId.LaborAusbau);
        }
