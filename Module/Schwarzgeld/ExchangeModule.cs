...
namespace VMP_CNR.Module.Schwarzgeld
{
    public class ExchangeModule : Module<ExchangeModule>
    {
        ...
        {
            if (dbPlayer == null || dbPlayer.RageExtension.IsInVehicle) return;
        ...
        public void LoadVehicle(DbPlayer dbPlayer)
        {
            ...
            // Create marker
            dbPlayer.Player.TriggerNewClient("createPlayerMarker", Exchange.ExchangeDestroyLocation);

            // Set gps marker
            dbPlayer.Player.TriggerNewClient("setPlayerGpsMarker", Exchange.ExchangeDestroyLocation.X, Exchange.ExchangeDestroyLocation.Y);
        ...
        public void DestroyExchange(DbPlayer dbPlayer)
        {
            ...
            Main.m_AsyncThread.AddToAsyncThread(new Task(async () =>
            {
                ...
                await NAPI.Task.WaitForMainThread(ExchangeValue / 2);
        ...
        public void FinishExchange(DbPlayer dbPlayer)
        {
            ...
            if (ExchangeVehicle != null)
            {
                ...
                dbPlayer.Player.TriggerNewClient("destroyPlayerMarker");
            }
