...
namespace VMP_CNR.Module.Heist.Planning
{
    public class PlanningRoom : Loadable<uint>
    {
        ...
        public void PurchasePlanningRoom(DbPlayer dbPlayer)
        {
            ...
            dbPlayer.Player.TriggerNewClient("setPlayerGpsMarker", location.X, location.Y);
        ...
        public void DeliverPlanningroomTrash(DbPlayer dbPlayer)
        {
            ...
            Main.m_AsyncThread.AddToAsyncThread(new Task(async () =>
            {
                ...
                await NAPI.Task.WaitForMainThread(PlanningModule.Instance.TimeToRecycleTrash / 10 * trashAmount);
        ...
        public void LoadInterior(DbPlayer dbPlayer)
        {
            ...
            dbPlayer.Player.TriggerNewClient("loadplanningroom", MainFloor, spiegel, einrichtung, MainFloorInteriorLevel, MainFloorSlotMachineLevel, NAPI.Util.ToJson(rewardIds), BasementLevel, BasementMechanicLevel, BasementHackerLevel, BasementWeaponsLevel, BasementWardrobeLevel, CasinoPlanLevel, CasinoPropDoor);
        }

        public void UnloadInterior(DbPlayer dbPlayer)
        {
            dbPlayer.Player.TriggerNewClient("unloadplanningroom");
        }
