...
namespace VMP_CNR.Module.Items.Scripts
{
    ...
    {
        public static async Task<bool> Stringer(DbPlayer dbPlayer, ItemModel ItemData)
        {
            if (dbPlayer.IsCuffed || dbPlayer.IsTied ||
                !dbPlayer.Team.IsCops() && !dbPlayer.Team.IsDpos() ||
            ...
            PoliceObjectModule.Instance.Add(1276148988, dbPlayer.Player, ItemData, true);
            dbPlayer.SendNewNotification(
