...
namespace VMP_CNR.Module.Items.Scripts
{
    ...
    {
        public static async Task<bool> BarriereArrow(DbPlayer dbPlayer, ItemModel ItemData)
        {
            if (dbPlayer.IsCuffed || dbPlayer.IsTied || dbPlayer.RageExtension.IsInVehicle || (!dbPlayer.Team.IsCops() && !dbPlayer.Team.IsDpos() && !dbPlayer.Team.IsMedics())) 
            { 
                return false; 
            } 
            ...
            PoliceObjectModule.Instance.Add(1867879106, dbPlayer.Player, ItemData, false);
