...
namespace VMP_CNR.Module.Teams
{
    public class DbTeam : Loadable<uint>
    {
        ...
        public Container MineContainerSchmelzeOutput { get; set; }
        ...
        protected DbTeam(MySqlDataReader reader) : base(reader)
        {
            ...
            if (IsBusinessTeam && Id == (uint)TeamTypes.TEAM_MINE1 || Id == (uint)TeamTypes.TEAM_MINE2)
            {
                ...
                MineContainerSchmelzeOutput = ContainerManager.LoadContainer(Id, ContainerTypes.MINECONTAINERSCHMELZEOUTPUT);
            }
        ...
        {
            return IsMethTeam() || IsWeedTeam() || IsWeaponTeam() || IsHeroinTeam() || IsBadOrga();
        }
        ...
        public bool IsHeroinTeam()
        {
            return TeamModule.Instance.IsHeroinTeamId(Id);
        }
