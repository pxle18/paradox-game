...
namespace VMP_CNR.Module.Kasino
{
    ...
    {
        [RemoteEvent]
        public void StartDiceGame(Player player, string returnString, string key)
        {
        ...
        [RemoteEvent]
        public void addCasinoDiceConfirm(Player p_Player, string p_InvitingPersonName, string p_CasinoDeviceId, string key)
        {
            ...
            {
                targetPlayer.SendNewNotification($"{dbPlayer.GetName()} ist nun auch dabei!", PlayerNotification.NotificationType.CASINO, KasinoDiceModule.Instance.DiceString);
            }
        }
