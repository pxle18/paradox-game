...
namespace VMP_CNR.Module.Vehicles.Data
{
    public class VehicleData
    {
        ...
        public uint VehDoorTrunk { get; }
        public uint VehDoorTrunk2 { get; }
        ...
        public VehicleData(MySqlDataReader reader)
        {
            ...
            VehDoorTrunk = reader.GetUInt32("vehdoor_trunk");
            VehDoorTrunk2 = reader.GetUInt32("vehdoor_trunk2");


            MaxSpeed = Convert.ToInt32(reader.GetInt32("max_speed")*VehicleSpeed.fakeMultiReverse);
            ...
            if (staticDatas != null && staticDatas.ContainsKey(Hash))
            {
