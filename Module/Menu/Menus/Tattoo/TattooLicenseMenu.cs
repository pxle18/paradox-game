...
namespace VMP_CNR
{
    public class TattooLicenseMenuBuilder : MenuBuilder
    {
        ...
        public override Menu Build(DbPlayer dbPlayer)
        {
            ...
            if (tattooshop == null)
            {
                dbPlayer.SendNewNotification("Der Lizenzenshop konnte dich keinem Tattooladen zuordnen. Melde dies bitte im GVMP-Bugtracker!", PlayerNotification.NotificationType.ERROR);
                return null;
            }
