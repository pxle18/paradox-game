...
namespace VMP_CNR.Module.Business.NightClubs
{
    public class NightClub : Loadable<uint>
    {
        ...
        public void LoadNightCLubInterrior(DbPlayer dbPlayer)
        {
            ...
            dbPlayer.Player.TriggerNewClient("loadNightclubInterrior", style, drinks, lights, effects, clubName, entryLight, security);
        }
        ...
        {
            dbPlayer.Player.TriggerNewClient("unloadNightclubInterrior");
        }
